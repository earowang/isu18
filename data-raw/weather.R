# https://raw.githubusercontent.com/hadley/nycflights13/master/data-raw/weather.R
...
stations <- union(unique(flights$origin), unique(flights$dest))
...
write_rds(weather, path = "data/weather.rds")
